...
class SpecialFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val selectionItems: List<SelectionItem> = listOf(
            ...
            SelectionItem(textLeft="Charisma", textRight="0", data=SelectionItemData(description="Charisma is your ability to charm and convince others. It affects your success to persuade others in dialogue and prices when you barter.", image=R.drawable.stat_charisma)),
            SelectionItem(textLeft="Intelligence", textRight="0", data=SelectionItemData(description="Intelligence is the measure of your overall mental acuity, and affects the number of experience points earned.", image=R.drawable.stat_intelligence)),
            SelectionItem(textLeft="Agility", textRight="0", data=SelectionItemData(description="Agility is a measure of your overall finesse and reflexes. It affects the number of Action Points in V.A.T.S. and your ability to sneak.", image=R.drawable.stat_agility)),
            SelectionItem(textLeft="Luck", textRight="0", data=SelectionItemData(description="Luck is a measure of your general good fortune, and affects the recharge rates of critical hits.", image=R.drawable.stat_luck))
        )
